...
export const metadata: Metadata = {
	...
	authors: [{ name: "Porter Loveless" }],
	creator: "Porter Loveless",
	openGraph: {
		title: "Porter Loveless - Developer Portfolio",
		description:
			"Passionate developer creating simple and effective solutions. Explore my projects and development approach.",
		url: "https://your-domain.com",
		siteName: "Porter Loveless - Portfolio",
		images: [
			{
				url: "/og-image.jpg",
				width: 1200,
				height: 630,
				alt: "Porter Loveless - Developer Portfolio",
			},
		],
		locale: "en_US",
		type: "website",
